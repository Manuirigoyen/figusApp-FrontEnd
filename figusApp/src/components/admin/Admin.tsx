...
import { ListarUsuarios } from './abm/listar/listarUsuario';
      ...
      <aside className={`admin-sidebar ${sidebarOpen ? 'is-open' : ''}`}>
        ...
        <nav className="admin-menu" aria-label="Navegación administrativa">
          ...
          <div className="admin-menu-group">
            ...
            >
              <button className="admin-submenu-btn" type="button" onClick={() => mostrarVista('agregar-figurita')}>
                Agregar figuritas
              </button>
              <button className="admin-submenu-btn" type="button" onClick={() => mostrarVista('agregar-sobre')}>
                Agregar sobres
              </button>
              <button className="admin-submenu-btn" type="button" onClick={() => mostrarVista('agregar-album')}>
                Agregar álbumes
              </button>
              <button className="admin-submenu-btn" type="button" onClick={() => mostrarVista('agregar-usuario')}>
                Agregar usuarios
              </button>
              <button className="admin-submenu-btn" type="button" onClick={() => mostrarVista('agregar-producto')}>
                Agregar productos
              </button>
            </div>
          </div>
          ...
          <div className="admin-menu-group">
            <button className="admin-menu-btn" type="button" onClick={toggleModificar}>
              Modificar
            </button>

            <div className={`admin-submenu ${modificarAbierto ? 'is-open' : ''}`}>
              <button className="admin-submenu-btn" type="button" onClick={() => mostrarVista('modificar-figurita')}>
                Modificar figuritas
              </button>
              <button className="admin-submenu-btn" type="button" onClick={() => mostrarVista('modificar-sobre')}>
                Modificar sobres
              </button>
              <button className="admin-submenu-btn" type="button" onClick={() => mostrarVista('modificar-album')}>
                Modificar álbumes
              </button>
              <button className="admin-submenu-btn" type="button" onClick={() => mostrarVista('modificar-usuario')}>
                Modificar usuarios
              </button>
              <button className="admin-submenu-btn" type="button" onClick={() => mostrarVista('modificar-producto')}>
                Modificar productos
              </button>
            </div>
          </div>
          ...
          <div className="admin-menu-group">
            <button className="admin-menu-btn" type="button" onClick={toggleEliminar}>
              Eliminar
            </button>

            <div className={`admin-submenu ${eliminarAbierto ? 'is-open' : ''}`}>
              <button className="admin-submenu-btn" type="button" onClick={() => mostrarVista('eliminar-figurita')}>
                Eliminar figuritas
              </button>
              <button className="admin-submenu-btn" type="button" onClick={() => mostrarVista('eliminar-sobre')}>
                Eliminar sobres
              </button>
              <button className="admin-submenu-btn" type="button" onClick={() => mostrarVista('eliminar-album')}>
                Eliminar álbumes
              </button>
              <button className="admin-submenu-btn" type="button" onClick={() => mostrarVista('eliminar-usuario')}>
                Eliminar usuarios
              </button>
              <button className="admin-submenu-btn" type="button" onClick={() => mostrarVista('eliminar-producto')}>
                Eliminar productos
              </button>
            </div>
          </div>
