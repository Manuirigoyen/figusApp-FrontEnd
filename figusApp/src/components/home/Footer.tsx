 ...
 * Contiene enlaces legales, contacto, formulario y referencias tecnológicas.
 */
export const Footer = () => {
  ...
  const contactEndpoint = import.meta.env.VITE_CONTACT_FORM_ENDPOINT as string;
    ...
    <footer id="footer" className="footer-section text-white pb-4 mt-0">
      <div className="container">
        <div className="row gy-4 justify-content-between">
          ...
          <div className="col-lg-4 col-md-6">
            <form
              className="w-100 text-center footer-form"
              aria-labelledby="consultas-title"
              onSubmit={handleSubmit}
            >
              <h6 id="consultas-title" className="footer-heading app-heading text-center mb-3">
                Consultas
              </h6>

              {errorMessage && (
                <p className="footer-feedback footer-feedback--error" aria-live="polite">
                  {errorMessage}
                </p>
              )}

              {successMessage && (
                <p className="footer-feedback footer-feedback--success" aria-live="polite">
                  {successMessage}
                </p>
              )}
              ...
              <select
                name="contact_reason"
                className="form-select footer-control mb-2 w-100"
                required
              ...
              <input
                type="email"
                name="contact_email"
                className="form-control footer-control mb-2 w-100"
              ...
              <button
                className="btn btn-light w-100 fw-bold mt-1 footer-submit-btn"
                type="submit"
                ...
                {paymentMethods.map((method) => (
                  <div key={method.alt} className="p-1">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      aria-label={`Pagar con ${method.alt}`}
